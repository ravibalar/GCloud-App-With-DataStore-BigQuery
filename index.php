...
<body>
    ...
    <div class='container'>
        <div class="h3 header text-center">Task 1 - Home</div>
        <div class="row profile">
            ...
            <div class="message-info col-md-9">
                ...
                <div class="message-content">
                    <div class="h3 header text-center">Forum</div>
                    <?php
                    try {
                        $messageQuery = $datastore->gqlQuery('SELECT * FROM `Message` ORDER BY posttime DESC LIMIT 10', [
                            'allowLiterals' => true
                        ]);
